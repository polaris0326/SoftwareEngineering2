...
public class CommodityPO {
	...
	public CommodityPO(String id, String name, String model, int amount,
	...
	public CommodityVO creatCommodityVO(){
		return new CommodityVO(id, name, model, amount, defaultPurchasePrice, defaultSellingPrice, recentPurchasePrice, recentSellingPrice);
