...
public class StrategyBLS_MarketStrategyManage_stub implements StrategyBLS_MarketStrategyManage{
	
	public ArrayList<MarketRebateStrategyVO> getMarketRebateList (){
		return new ArrayList<MarketRebateStrategyVO>();
	}
	public ArrayList<MarketVoucherStrategyVO> getMarketVoucherList(){
		return new ArrayList<MarketVoucherStrategyVO>();
	}
